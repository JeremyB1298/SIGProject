<?php 
    ...
    class Data {
        ...
        public function getGeoPointTab() {
            ...
            while ($donnees = $reponse->fetch()) {
                array_push($tableauGeoPoint, new GeoArc($donnees['GEO_POI_ID'], $donnees['GEO_POI_LATITUDE'], $donnees['GEO_POI_LONGITUDE'], $donnees['GEO_POI_NOM'], $donnees['GEO_ARC_PARTITION']));    
                echo '<br>';		
            }
            $reponse->closeCursor();
            return $tableauGeoArc;
